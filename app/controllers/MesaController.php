      ...
      if (!$mesaModificar) {
        ...
        if (($id_sector == 6 && $codigo_mesa_estado == 4) || ($id_sector == 5 && $codigo_mesa_estado != 4)) {
          ...
          if (($codigo_mesa_estado == 4 && $mesaModificar->codigo_estado_mesa != 3) || ($codigo_mesa_estado == 3 && $mesaModificar->codigo_estado_mesa != 2) ||
            ...
            switch ($codigo_mesa_estado) {
              case 1:
                $payload = json_encode(array("Mensaje" => "Mesa cliente esperando pedido"));
                break;
              case 2:
                $payload = json_encode(array("Mensaje" => "Mesa cliente comiendo"));
                break;
              case 3:
                $payload = json_encode(array("Mensaje" => "Mesa cliente pagando"));
                break;
              case 4:
